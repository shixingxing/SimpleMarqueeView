# SimpleMarqueeView [ ![Download](https://api.bintray.com/packages/liyz/lyzlib/SimpleMarqueeView/images/download.svg?version=1.2.0) ](https://bintray.com/liyz/lyzlib/SimpleMarqueeView/1.2.0/link)
